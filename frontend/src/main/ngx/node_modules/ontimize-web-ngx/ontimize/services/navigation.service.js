...
var NavigationService = (function () {
    ...
    NavigationService.prototype.getLastMainNavigationRouteData = function () {
        ...
        while (!item && maxMatches >= 0) {
            item = items.find(function (item, i) { return (item.isMainNavigationComponent() || item.isMainFormLayoutManagerComponent()) && routeMatches[i] === maxMatches; });
            maxMatches--;
        }
        return item;
    };
    ...
    NavigationService.prototype.removeLastItemsUntilMain = function () {
        var index = this.navigationItems.indexOf(this.getLastMainNavigationRouteData());
