...
var OTranslateService = (function () {
    ...
    OTranslateService.prototype.storeLanguage = function (language) {
        if (language) {
            var dataStr = localStorage.getItem(this.localStorageKey);
            var data = (dataStr && dataStr.length > 0) ? JSON.parse(dataStr) : {};
            data[Codes.LANGUAGE_KEY] = language;
            localStorage.setItem(this.localStorageKey, JSON.stringify(data));
        }
    };
    OTranslateService.prototype.getStoredLanguage = function () {
        var dataStr = localStorage.getItem(this.localStorageKey);
    ...
    OTranslateService.prototype.use = function (lang, observer) {
        ...
        if (lang === undefined) {
            ...
            this.checkExistingLangFile(lang).then(function (exists) {
                var newLang = lang;
                if (!exists) {
                    newLang = Util.isDefined(_this.appConfig['_config']['defaultLocale']) ? _this.appConfig['_config']['defaultLocale'] : _this.ngxTranslateService.getDefaultLang();
