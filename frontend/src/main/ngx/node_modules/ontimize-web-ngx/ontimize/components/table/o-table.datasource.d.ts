...
export declare class OTableDataSource extends DataSource<any> {
    ...
    protected _columnValueFilterChange: Subject<{}>;
    ...
    initializeColumnsFilters(filters: IColumnValueFilter[]): void;
    ...
    addColumnFilter(filter: IColumnValueFilter): void;
