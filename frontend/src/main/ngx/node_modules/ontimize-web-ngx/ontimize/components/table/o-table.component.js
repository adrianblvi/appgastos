...
import { ChangeDetectionStrategy, Component, ContentChild, ContentChildren, ElementRef, EventEmitter, forwardRef, HostListener, Inject, Injector, NgModule, Optional, QueryList, TemplateRef, ViewChild, ViewChildren, ViewEncapsulation } from '@angular/core';
...
import { O_TABLE_FOOTER_COMPONENTS, OTableColumnAggregateComponent, OTableMatPaginatorIntl, OTablePaginatorComponent } from './extensions/footer/o-table-footer-components';
import { ColumnValueFilterOperator, O_TABLE_HEADER_COMPONENTS, OTableButtonComponent, OTableButtonsComponent, OTableMenuComponent, OTableOptionComponent, OTableQuickfilterComponent } from './extensions/header/o-table-header-components';
...
var OTableComponent = (function (_super) {
    ...
    OTableComponent.propDecorators = {
        ...
        quickfilterContentChild: [{ type: ContentChild, args: [OTableQuickfilterComponent,] }],
        exportOptsTemplate: [{ type: ViewChild, args: ['exportOptsTemplate',] }]
    };
    __decorate([
        InputConverter(),
